...
class Builder:
    ...
    def check_environment(self):
        ...
        # Pre-generate comtypes cache for UI Automation
        if platform.system() == "Windows":
            try:
                print("Generating comtypes cache for UIAutomation...")
                subprocess.run(
        ...
        try:
            ...
            if not exe_path.exists():
                ...
                if exes:
                    ...
                    print("No executable found! ZIP archive may be incomplete.")
            
            # Create the zip file from just the dist directory contents (not including dist itself)
